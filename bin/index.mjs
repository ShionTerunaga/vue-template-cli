...
var G$1 = "m";
var _$1 = `${nD}8;;`;
var z = (e) => `${d$1.values().next().value}${V$1}${e}${G$1}`;
var K$1 = (e) => `${d$1.values().next().value}${_$1}${e}${y$1}`;
...
var PD = (e, u, t) => u in e ? OD(e, u, {
	enumerable: !0,
	configurable: !0,
	writable: !0,
	value: t
}) : e[u] = t;
var J$1 = (e, u, t) => (PD(e, typeof u != "symbol" ? u + "" : u, t), t);
...
var RD = class extends x {
	get valueWithCursor() {
		...
		return `${u}${import_picocolors_browser.default.inverse(t)}${F.join("")}`;
	}
	get cursor() {
		return this._cursor;
	}
...
var b = (t) => {
	switch (t) {
		case "initial":
		case "active": return import_picocolors_browser.default.cyan(le);
		case "cancel": return import_picocolors_browser.default.red(L);
		case "error": return import_picocolors_browser.default.yellow(W);
		case "submit": return import_picocolors_browser.default.green(C);
	}
};
var G = (t) => {
	...
	return r.slice(l, l + a).map((p, v, f) => {
		...
		return j || E ? import_picocolors_browser.default.dim("...") : i(p, v + l === n);
	});
};
var he = (t) => new RD({
	validate: t.validate,
	...
	render() {
		const n = `${import_picocolors_browser.default.gray(o)}
${b(this.state)}  ${t.message}
`, r = t.placeholder ? import_picocolors_browser.default.inverse(t.placeholder[0]) + import_picocolors_browser.default.dim(t.placeholder.slice(1)) : import_picocolors_browser.default.inverse(import_picocolors_browser.default.hidden("_")), i = this.value ? this.valueWithCursor : r;
		switch (this.state) {
			case "error": return `${n.trim()}
${import_picocolors_browser.default.yellow(o)}  ${i}
${import_picocolors_browser.default.yellow(d)}  ${import_picocolors_browser.default.yellow(this.error)}
`;
			case "submit": return `${n}${import_picocolors_browser.default.gray(o)}  ${import_picocolors_browser.default.dim(this.value || t.placeholder)}`;
			case "cancel": return `${n}${import_picocolors_browser.default.gray(o)}  ${import_picocolors_browser.default.strikethrough(import_picocolors_browser.default.dim(this.value ?? ""))}${this.value?.trim() ? `
${import_picocolors_browser.default.gray(o)}` : ""}`;
			default: return `${n}${import_picocolors_browser.default.cyan(o)}  ${i}
${import_picocolors_browser.default.cyan(d)}
`;
		}
	}
}).prompt();
var ye = (t) => {
	...
	return new dD({
		...
		render() {
			const i = `${import_picocolors_browser.default.gray(o)}
${b(this.state)}  ${t.message}
`, s = this.value ? n : r;
			switch (this.state) {
				case "submit": return `${i}${import_picocolors_browser.default.gray(o)}  ${import_picocolors_browser.default.dim(s)}`;
				case "cancel": return `${i}${import_picocolors_browser.default.gray(o)}  ${import_picocolors_browser.default.strikethrough(import_picocolors_browser.default.dim(s))}
${import_picocolors_browser.default.gray(o)}`;
				default: return `${i}${import_picocolors_browser.default.cyan(o)}  ${this.value ? `${import_picocolors_browser.default.green(k)} ${n}` : `${import_picocolors_browser.default.dim(P)} ${import_picocolors_browser.default.dim(n)}`} ${import_picocolors_browser.default.dim("/")} ${this.value ? `${import_picocolors_browser.default.dim(P)} ${import_picocolors_browser.default.dim(r)}` : `${import_picocolors_browser.default.green(k)} ${r}`}
${import_picocolors_browser.default.cyan(d)}
`;
			}
		}
...
var ve = (t) => {
	const n = (r, i) => {
		...
		switch (i) {
			case "selected": return `${import_picocolors_browser.default.dim(s)}`;
			case "active": return `${import_picocolors_browser.default.green(k)} ${s} ${r.hint ? import_picocolors_browser.default.dim(`(${r.hint})`) : ""}`;
			case "cancelled": return `${import_picocolors_browser.default.strikethrough(import_picocolors_browser.default.dim(s))}`;
			default: return `${import_picocolors_browser.default.dim(P)} ${import_picocolors_browser.default.dim(s)}`;
		}
	};
	return new LD({
		options: t.options,
		initialValue: t.initialValue,
		render() {
			const r = `${import_picocolors_browser.default.gray(o)}
${b(this.state)}  ${t.message}
`;
			switch (this.state) {
				case "submit": return `${r}${import_picocolors_browser.default.gray(o)}  ${n(this.options[this.cursor], "selected")}`;
				case "cancel": return `${r}${import_picocolors_browser.default.gray(o)}  ${n(this.options[this.cursor], "cancelled")}
${import_picocolors_browser.default.gray(o)}`;
				default: return `${r}${import_picocolors_browser.default.cyan(o)}  ${G({
					cursor: this.cursor,
					options: this.options,
					maxItems: t.maxItems,
					style: (i, s) => n(i, s ? "active" : "inactive")
				}).join(`
${import_picocolors_browser.default.cyan(o)}  `)}
${import_picocolors_browser.default.cyan(d)}
`;
			}
		}
...
var xe = (t = "") => {
	process.stdout.write(`${import_picocolors_browser.default.gray(d)}  ${import_picocolors_browser.default.red(t)}

`);
};
var M = {
	message: (t = "", { symbol: n = import_picocolors_browser.default.gray(o) } = {}) => {
		const r = [`${import_picocolors_browser.default.gray(o)}`];
		if (t) {
			const [i, ...s] = t.split(`
`);
			r.push(`${n}  ${i}`, ...s.map((c) => `${import_picocolors_browser.default.gray(o)}  ${c}`));
		}
...
`);
	...
	info: (t) => {
		M.message(t, { symbol: import_picocolors_browser.default.blue(q) });
	},
	success: (t) => {
		M.message(t, { symbol: import_picocolors_browser.default.green(D) });
	},
	step: (t) => {
		M.message(t, { symbol: import_picocolors_browser.default.green(C) });
	},
	warn: (t) => {
		M.message(t, { symbol: import_picocolors_browser.default.yellow(U) });
	},
	warning: (t) => {
		M.warn(t);
	},
	error: (t) => {
		M.message(t, { symbol: import_picocolors_browser.default.red(K) });
	}
};
`${import_picocolors_browser.default.gray(o)}`;
//#endregion
...
function createSome(value) {
	return {
		kind: basic$1.OPTION_SOME,
		value
	};
}
function createNone() {
	return { kind: basic$1.OPTION_NONE };
}
function isSome(option) {
	return option.kind === basic$1.OPTION_SOME;
}
function isNone(option) {
	return option.kind === basic$1.OPTION_NONE;
}
...
var UNIT = Object.freeze({ _unit: Symbol("UNIT_SYMBOL") });
...
async function getCurrentVersion() {
	...
	if (isNone(optionVersion)) return createErr(/* @__PURE__ */ new Error("version is not found in version.json"));
...
var commanderCore = (async function() {
	...
	return new Command("create-frontend-template").version(currentVersion, "-v, --version", "output the current version").argument("[directory]").usage("[directory] [options]").helpOption("-h, --help", "display help for command").allowUnknownOption().option("-n, --name <name>", "specify the project name").option("--rf, --framework <framework>", "framework to use (tanstack-router | next/app | next/pages)").option("-c,--css <css>", "select css framework (tailwind | vanilla-extract)").option("--use-all-components", "install all available components").parse(process.argv);
})();
function onPromptCancel(value) {
	if (pD(value)) {
...
async function nameCommand(optionName) {
	if (isSome(optionName) && isString(optionName.value)) return createOk(optionName.value.trim());
	const response = await checkPromiseReturn({
		...
		err: (e) => {
			if (e instanceof Error) return createErr(/* @__PURE__ */ new Error(`Prompt failed: ${e.message}`));
			return createErr(/* @__PURE__ */ new Error("Prompt failed: Unknown error"));
		}
	});
	if (isErr(response)) return response;
	onPromptCancel(response.value);
	const name = optionConversion(response.value);
	if (isSome(name) && isString(name.value)) return createOk(name.value.trim());
...
function isFolderEmpty(root, name) {
	...
	if (conflicts.length > 0) {
		M.message(`The directory ${(0, import_picocolors_browser.green)(name)} contains files that could conflict:`);
		for (const file of conflicts) try {
			if (lstatSync(join(root, file)).isDirectory()) M.message((0, import_picocolors_browser.blue)(`  ${file}/`));
			else M.message(`  ${file}`);
		} catch {
			M.message(`  ${file}`);
		}
		M.message("Either try using a new directory name, or remove the files listed above.");
		return false;
	}
	return true;
}
...
async function typescriptTemplateInstall({ root, appName, material }) {
	...
	if (!isFolderEmpty(root, appName)) return createErr(/* @__PURE__ */ new Error(`The directory ${appName} is not empty. Please choose a different project name or remove the existing directory.\n`));
	M.step(`Creating a new React app in ${(0, import_picocolors_browser.green)(root)}.`);
	process.chdir(root);
	...
	const exists = await checkPromiseVoid({
		...
		err: (e) => {
			if (e instanceof Error) return createErr(/* @__PURE__ */ new Error(`Failed to access package.json: ${e.message}`));
			return createErr(/* @__PURE__ */ new Error("Failed to access package.json: Unknown error"));
		}
	});
	if (isErr(exists)) return exists;
	const raw = await fs$1.readFile(pkgPath, "utf8");
	const pkg = JSON.parse(raw || "{}");
	if (!appName || typeof appName !== "string") return createErr(/* @__PURE__ */ new Error("Invalid app name"));
	pkg.name = appName;
	pkg.version = "0.1.0";
	const writeResult = await checkPromiseVoid({
		...
		err: () => createErr(/* @__PURE__ */ new Error(`Failed to update package.json name`))
	});
	if (isErr(writeResult)) return writeResult;
	return createOk(UNIT);
}
//#endregion
//#region src/template/tech/installer.ts
async function installApp({ appPath, material }) {
	const { styleSheet } = material;
	const root = resolve(appPath);
	const appName = basename(appPath);
	if (isNone(styleSheet)) return createErr(/* @__PURE__ */ new Error("CSS option is required"));
...
//#endregion
//#region src/shared/tech.static.ts
var techSchema = {
	frameworks: [{
		label: "Vue Router",
		value: "vue-router"
...
async function cssCommand({ optionCss, isCss, csses }) {
	if (isSome(optionCss) && isCss(optionCss.value)) return createOk(optionCss.value);
	const response = await checkPromiseReturn({
		fn: async () => await ve({
	...
	if (isSome(css) && isCss(css.value)) return createOk(css.value);
	return createErr(/* @__PURE__ */ new Error("CSS selection is invalid"));
}
//#endregion
//#region src/command/tech/validation.ts
function isFramework(value) {
	return typeof value === "string" && techSchema.frameworks.some((framework) => framework.value === value);
}
function isCss(value) {
	return typeof value === "string" && techSchema.css.some((css) => css.value === value);
}
//#endregion
//#region src/command/tech/css.ts
async function selectCss(optionCss) {
...
//#endregion
//#region src/command/tech/framework.ts
async function selectFramework(optionFramework) {
	if (isSome(optionFramework) && isFramework(optionFramework.value)) return createOk(optionFramework.value);
	const response = await checkPromiseReturn({
		fn: async () => await ve({
		...
		err: (error) => {
			if (error instanceof Error) return createErr(/* @__PURE__ */ new Error(`Prompt failed: ${error.message}`));
			return createErr(/* @__PURE__ */ new Error("Prompt failed: Unknown error"));
		}
	});
	if (isErr(response)) return response;
	onPromptCancel(response.value);
	if (isFramework(response.value)) return createOk(response.value);
	return createErr(/* @__PURE__ */ new Error("Framework selection is invalid"));
}
//#endregion
//#region src/command/common/commander-option.ts
async function optionCommand(opt) {
	return optionConversion(opt);
}
var optionName = (async function() {
	return await optionCommand((await commanderCore).opts().name);
})();
var optionFramework = (async function() {
	return await optionCommand((await commanderCore).opts().framework);
})();
var optionCss = (async function() {
	const css = (await commanderCore).opts().css;
	return await optionCommand(css);
})();
(async function() {
	return await optionCommand((await commanderCore).opts().useAllComponents);
})();
//#endregion
//#region src/utils/found-file.ts
function foundFolder(paths) {
	for (const p of paths) if (fs.existsSync(p)) return createOk(p);
	return createErr(/* @__PURE__ */ new Error(`Not found folder: ${paths.join(", ")}`));
}
//#endregion
//#region src/template/tech/setting.ts
async function resolveTemplate() {
	const cliDir = path.dirname(fileURLToPath(import.meta.url));
	const frameworkResult = await selectFramework(await optionFramework);
	if (isErr(frameworkResult)) return frameworkResult;
	const cssResult = await selectCss(await optionCss);
	if (isErr(cssResult)) return cssResult;
	const resultPath = foundFolder([path.join(cliDir, "template", frameworkResult.value, cssResult.value)]);
	if (isErr(resultPath)) return resultPath;
	return createOk({
...
async function createApp({ appPath }) {
	const materialResult = await resolveTemplate();
	if (isErr(materialResult)) return materialResult;
...
function showNextSteps() {
	M.message(`Package install:\n\n ex) npm install`);
	M.message(`Application launch:\n\n ex) npm run dev`);
}
//#endregion
...
//#endregion
//#region src/helper/get-latest-version.ts
var REPOSITORY_OWNER = "ShionTerunaga";
var REPOSITORY_NAME = "vue-template-cli";
var GITHUB_API_BASE = "https://api.github.com";
function normalizeVersion$1(tagName) {
	const version = tagName.trim().replace(/^v/, "");
	if (version === "") throw new Error("Latest tag name is empty");
	return version;
}
...
async function fetchLatestTagVersion() {
	...
	if (!isArray(payload) || payload.length === 0) throw new Error("GitHub tags response is empty");
	const [latestTag] = payload;
	if (typeof latestTag !== "object" || latestTag === null || !("name" in latestTag) || !isString(latestTag.name)) throw new Error("GitHub tags response does not contain a valid tag name");
	return normalizeVersion$1(latestTag.name);
}
async function getLatestVersion() {
	return checkPromiseReturn({
		fn: fetchLatestTagVersion,
		err: (error) => error instanceof Error ? createErr(/* @__PURE__ */ new Error(`Failed to resolve the latest repository tag: ${error.message}`)) : createErr(/* @__PURE__ */ new Error("Failed to resolve the latest repository tag"))
	});
}
//#endregion
//#region src/command/version/continue-current-version.ts
async function continueCurrentVersionCommand() {
	const response = await checkPromiseReturn({
		fn: async () => await ye({
...
var INSTALL_COMMAND = "npm i -g github:ShionTerunaga/frontend-template-cli#release";
process.on("SIGTERM", handleSigTerm);
process.on("SIGINT", handleSigTerm);
async function run() {
	if (process.env.CLI_TEST !== "1") await checkCliVersion();
...
function normalizeVersion(version) {
	return version.trim().replace(/^v/, "").split(".").map((part) => Number.parseInt(part, 10) || 0);
}
function isNewerVersion(latestVersion, currentVersion) {
	const latestParts = normalizeVersion(latestVersion);
	const currentParts = normalizeVersion(currentVersion);
	if (latestParts.length !== 3 || currentParts.length !== 3) throw new Error(`Invalid version format. Expected format is "x.y.z". latestVersion: ${latestVersion}, currentVersion: ${currentVersion}`);
...
async function checkCliVersion() {
	const currentVersionResult = await getCurrentVersion();
	if (isErr(currentVersionResult)) return currentVersionResult;
	const currentVersion = currentVersionResult.value;
	const latestVersionResult = await getLatestVersion();
	if (isErr(latestVersionResult)) return latestVersionResult;
	const latestVersion = latestVersionResult.value;
	if (!isNewerVersion(latestVersion, currentVersion)) return createOk(UNIT);
	M.warn((0, import_picocolors_browser.red)(`A newer version of create-frontend-template is available. current: v${currentVersion}, latest: v${latestVersion}`));
	...
	if (continueCurrentVersionResult.value) return createOk(UNIT);
	M.message(`Install the latest version with the following command:\n\n${(0, import_picocolors_browser.bold)((0, import_picocolors_browser.green)(INSTALL_COMMAND))}`);
	process.exit(0);
}
function notify(projectMaterial) {
	M.message("cd " + projectMaterial.name);
	showNextSteps();
	M.success((0, import_picocolors_browser.bold)(`${(0, import_picocolors_browser.green)("Happy hacking!")}`));
	process.exit(0);
}
function errorExit() {
